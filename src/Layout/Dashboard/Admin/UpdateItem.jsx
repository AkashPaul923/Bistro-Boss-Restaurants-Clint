...
const UpdateItem = () => {
    ...
    const onSubmit = async (data) => {
        ...
        if(res.data.success){
            ...
            const menuRes = await axiosSecure.patch(`/menu/${_id}`, menuData)
  ...
  return (
    <div>
        <SectionTitle title='Update An Item' subTitle="Whats's new?"></SectionTitle>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="bg-white shadow-md rounded px-8 pt-6 pb-8 w-full max-w-2xl">
                ...
                <div className="flex space-x-4 mb-4">
                    ...
                    <div className="w-1/2">
                        ...
                        <input defaultValue={price} {...register("price")} type="text" placeholder="Price" className="input input-bordered w-full" required/>
                    </div>
                </div>
                ...
                <div className="mb-4">
                    ...
                    <textarea defaultValue={recipe} {...register("recipe")} placeholder="Recipe Details" className="textarea textarea-bordered w-full" required/>
                </div>
                ...
                > <FaUtensils className="mr-2" /> <span>Update Item</span>
                </button>
            </form>
        </div>
    </div>
